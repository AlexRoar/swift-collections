...
typealias TreeArray = OrderedCollections.TreeArrayContinous

extension Benchmark {
    public mutating func addTreeArrayBenchmarks() {
        self.addSimple(
        ...
        self.add(
            ...
            return { timer in
                var array = TreeArray(0 ..< input.count)
                timer.measure {
                    var v = 0
                    for i in input {
                        array.swapAt(i, v)
        ...
        self.add(
            ...
            return { timer in
                var array = TreeArray(0 ..< removals.count)
                timer.measure {
                    for i in removals {
                        array.remove(at: i)
                    }
